...
set CBVERSION=%1
"%ProgramFiles(x86)%\WiX Toolset v3.11\bin\candle.exe" -arch x64 chrome-bisect.wxs
"%ProgramFiles(x86)%\WiX Toolset v3.11\bin\light.exe" -ext "%ProgramFiles(x86)%\WiX Toolset v3.11\bin\WixUIExtension.dll" chrome-bisect.wixobj -o chrome-bisect-%1-windows.msi
